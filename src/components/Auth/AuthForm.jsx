		...
		<div className="AuthForm">
			...
			<form action="/auth">
				...
				<div className="form-item">
					<div
						style={{
							backgroundImage:
								"url('https://adsl.tci.ir/panel/captcha/?r=1646201822')",
						}}
			...
			<div className="form-item remember-box">
				<a
					...
					data-hovername="rememberPassword"
					className={
						"textDrap " +
						(formInfo.rememberPasswordHoverd
							? "textDrap-active"
							: "") +
						" textDrap-top"
					}
					data-textdrap="رمز عبور خود را فراموش کرده ام"
				>
				...
				<a
					...
					onMouseEnter={onHover}
					onMouseLeave={onHover}
					data-hovername="quickPay"
					className={
						"textDrap " +
						(formInfo.quickPayHoverd ? "textDrap-active" : "") +
						" textDrap-bottom"
					}
					data-textdrap="بدون نیاز به کلمه عبور"
				>
					شارژ سریع
				</a>
			</div>
